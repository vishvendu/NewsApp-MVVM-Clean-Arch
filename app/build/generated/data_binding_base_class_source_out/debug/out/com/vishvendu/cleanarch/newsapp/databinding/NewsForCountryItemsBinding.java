...
public final class NewsForCountryItemsBinding implements ViewBinding {
  @NonNull
  ...
  private NewsForCountryItemsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static NewsForCountryItemsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NewsForCountryItemsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.news_for_country_items, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NewsForCountryItemsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NewsForCountryItemsBinding((ConstraintLayout) rootView, imageViewBanner,
