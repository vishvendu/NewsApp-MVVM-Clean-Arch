...
public final class NewsInLanguageItemsBinding implements ViewBinding {
  @NonNull
  ...
  private NewsInLanguageItemsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static NewsInLanguageItemsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NewsInLanguageItemsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.news_in_language_items, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NewsInLanguageItemsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NewsInLanguageItemsBinding((ConstraintLayout) rootView, imageViewBanner,
