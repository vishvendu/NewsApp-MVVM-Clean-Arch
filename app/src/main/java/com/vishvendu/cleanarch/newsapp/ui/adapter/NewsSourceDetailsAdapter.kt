...
import com.vishvendu.cleanarch.newsapp.databinding.NewsSourceDetailsItemLayoutBinding

class NewsSourceDetailsAdapter(private val article: ArrayList<Article>) :
